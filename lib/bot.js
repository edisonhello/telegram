        ...
        if(text=="jizz"){
            ...
            if(sub!=""){console.log("jizz");
                if(sub.indexOf("random")==0){
                    ...
                    setTimeout(function(){
                        sm(id,"├if <how much> > 0, return random number 1~<how much>");
                    },100);
                    setTimeout(function(){
                        sm(id,"└if <how much> < 0, return random number 0~<how much>");
                    },200);
                    setTimeout(function(){
                        sm(id,"random -s [thing,[things ...]]");
                    },300);
                    setTimeout(function(){
                        sm(id,"└return thing in things");
                    },400);
                }
                else{
                    sm(id,"unknown command");
                }
            }
            else{
                sm(id,"list");
